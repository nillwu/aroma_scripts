...
(function() {
  var addSelectBoxx, addSelectItem, cancel, getResponse, initDiv, pickEco;
  ...
  addSelectBoxx = function(eco, sourceV) {
    var dialogOpts, sid, url;
  ...
  pickEco = (function(_this) {
    return function(e) {
      initDiv($("#dialog"));
      return addSelectBoxx(e.data.name, e.data.sourceV);
    };
  })(this);

  initDiv = function($select) {
    return $select.html('');
  };
